...
def lambda_handler(event, context):
    try:
        ...
        if event['RequestType'] == 'Create':
            ...
            response = cf_requester_client.describe_stack_resource(StackName=CloudFormationNameRequester,LogicalResourceId='VaultSG')
            ...
            response = cf_accepter_client.describe_stack_resource(StackName=CloudFormationNameAccepter,LogicalResourceId='VaultSG')
            ...
            security_group_requester.authorize_ingress(IpPermissions=[{'FromPort': 1858,'IpProtocol':'tcp','IpRanges': [{'CidrIp': vpc_cidr_accepter,'Description': 'Allow 1858 over TCP'}],'ToPort': 1858},{'IpRanges': [{'CidrIp': vpc_cidr_accepter,'Description': 'Allow 1858 over UDP'}],'FromPort':1858,'ToPort':1858,'IpProtocol':'udp'},{'IpRanges': [{'CidrIp': vpc_cidr_accepter,'Description': 'Vault to Vault DR ICMP connection'}],'FromPort':-1,'ToPort':-1,'IpProtocol':'icmp'},])
            security_group_requester.authorize_egress(IpPermissions=[{'FromPort': 1858,'IpProtocol':'tcp','IpRanges': [{'CidrIp': vpc_cidr_accepter,'Description': 'Allow 1858 over TCP'}],'ToPort': 1858},{'IpRanges': [{'CidrIp': vpc_cidr_accepter,'Description': 'Allow 1858 over UDP'}],'FromPort':1858,'ToPort':1858,'IpProtocol':'udp'},{'IpRanges': [{'CidrIp': vpc_cidr_accepter,'Description': 'Vault to Vault DR ICMP connection'}],'FromPort':-1,'ToPort':-1,'IpProtocol':'icmp'},])
            security_group_accepter.authorize_ingress(IpPermissions=[{'FromPort': 1858,'IpProtocol':'tcp','IpRanges': [{'CidrIp': vpc_cidr_requester,'Description': 'Allow 1858 over TCP'}],'ToPort': 1858},{'IpRanges': [{'CidrIp': vpc_cidr_requester,'Description': 'Allow 1858 over UDP'}],'FromPort':1858,'ToPort':1858,'IpProtocol':'udp'},{'IpRanges': [{'CidrIp': vpc_cidr_requester,'Description': 'Vault to Vault DR ICMP connection'}],'FromPort':-1,'ToPort':-1,'IpProtocol':'icmp'}])
            security_group_accepter.authorize_egress(IpPermissions=[{'FromPort': 1858,'IpProtocol':'tcp','IpRanges': [{'CidrIp': vpc_cidr_requester,'Description': 'Allow 1858 over TCP'}],'ToPort': 1858},{'IpRanges': [{'CidrIp': vpc_cidr_requester,'Description': 'Allow 1858 over UDP'}],'FromPort':1858,'ToPort':1858,'IpProtocol':'udp'},{'IpRanges': [{'CidrIp': vpc_cidr_requester,'Description': 'Vault to Vault DR ICMP connection'}],'FromPort':-1,'ToPort':-1,'IpProtocol':'icmp'}])
